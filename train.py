...
def run(cfg: DictConfig) -> None:
    ...
    print("Data module : ", cfg.data.datamodule)
    ...
    # Instantiate model
    hydra.utils.log.info(f"Instantiating model : <{cfg.model._target_}>")
...
@hydra.main(config_path=str(PROJECT_ROOT / "conf"), config_name="train_protein")
